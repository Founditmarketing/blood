  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#fdfcf8]">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10"
      >
        <div className="text-center lg:text-left order-2 lg:order-1">
          <motion.div variants={itemVariants} className="inline-flex items-center gap-3 mb-8 px-4 py-2 border border-amber-200/50 rounded-full bg-amber-50/30">
            <span className="w-1.5 h-1.5 bg-amber-500 rounded-full animate-ping"></span>
            <span className="text-[10px] uppercase tracking-[0.25em] font-black text-amber-800">New Journal Series Live</span>
          </motion.div>

          <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl font-serif font-black text-stone-900 leading-[0.85] mb-10">
            Vernon <br />
            <span className="text-stone-400 italic font-medium">Daniel</span> Blood
          </motion.h1>

          <motion.p variants={itemVariants} className="text-xl text-stone-600 mb-12 max-w-lg leading-relaxed font-light italic">
        ...
        <motion.div variants={itemVariants} className="order-1 lg:order-2 flex justify-center">
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-white p-6 shadow-2xl rounded-sm border border-stone-100 transform rotate-1 group-hover:rotate-0 transition-all duration-700 hover:-translate-y-2">
              <img
                src={AUTHOR_PHOTO}
